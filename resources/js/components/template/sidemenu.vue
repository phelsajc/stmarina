    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item"
            :class="{ 'menu-open': this.$route.name == 'company_add' || this.$route.name == 'product_add' || this.$route.name == 'rproduct_add' || this.$route.name == 'rproduct_list' || this.$route.name == 'company_list' || this.$route.name == 'product_list' }">
            <a href="#" class="nav-link"
              :class="{ 'active': this.$route.name == 'rproduct_list' || this.$route.name == 'company_list' || this.$route.name == 'product_list' }">
          ...
          <li class="nav-item"
            :class="{ 'menu-open': this.$route.name == 'collection_add' || this.$route.name == 'collection_list' || this.$route.name == 'collection_reports' }">
            <a href="#" class="nav-link"
              :class="{ 'active': this.$route.name == 'collection_list' || this.$route.name == 'collection_reports' }">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link to="/collection_list" class="collapse-item"><a href="#" class="nav-link"
                    :class="{ 'active': this.$route.name == 'collection_list' || this.$route.name == 'collection_add' }">
                    <i class="far fa-circle nav-icon"></i>
                    List
                  </a></router-link>
              </li>
              <li class="nav-item">
                <router-link to="/collection_reports" class="collapse-item"> <a href="#" class="nav-link"
                    :class="{ 'active': this.$route.name == 'collection_reports' }">
                    <i class="far fa-circle nav-icon"></i>
                    Reports
                  </a></router-link>
              </li>
          ...
          <li class="nav-item">
            <router-link to="/collectibles_list" class="collapse-item"><a href="#" class="nav-link" id="collectiblesmenu"
                :class="{ 'active': this.$route.name == 'collectibles_list' }">
                <i class="far fa-circle nav-icon"></i>
                Collectibles
              </a> </router-link>
          </li>
          ...
          <li class="nav-item"
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link to="/transaction_list" class="collapse-item"> <a href="#" class="nav-link" id="usermenu"
