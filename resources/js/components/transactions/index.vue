                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      ...
                      <router-link to="/transaction" class="btn btn-primary">Add</router-link>
                    </div>
                    ...
                    <div class="card-body"> 
                      ...
                      <span class="badge badge-secondary">  {{e.tdate}}</span>
                                          </div>
                                          <div class="col-md-6  float-right">
                          <button class="btn btn-success float-right" @click="view(e.id)">View</button>
