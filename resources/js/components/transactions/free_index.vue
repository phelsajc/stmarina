            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <router-link to="/free_transaction/0" class="btn btn-primary">Add</router-link>
                </div>
                ...
                <div class="card-body">
                  ...
                  <ul class="list-group">
                    ...
                    <router-link v-for="e in filtersearch" :key="e.id" :to="{ name: 'free_transaction', params: { id: e.id } }">
...
export default {
  ...
  methods: {
    allEmployee() {
      this.isHidden = false
      axios.get('/api/transactionsFree')
        .then(({ data }) => (
    ...
    filterEmployee() {
      ...
      this.form.start = 0
      this.isHidden = false
      axios.post('/api/transactionsFree', this.form)
