            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <router-link to="/collection_add/0" class="btn btn-primary"
                    >Add</router-link
                  >
                </div>
                ...
                <div class="card-body">
                  ...
                  <ul class="list-group">
                    ...
                    <router-link v-for="e in filtersearch" :key="e.id" :to="{name: 'collection_add',params:{id:e.id}}">    
        ...
        /* async  check_doctors_detail(id) {
          ...
          filterEmployee(){
            ...
            this.isHidden =  false
              ...
              axios.post('/api/collection',this.form)
